...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-6">
      ...
      <form method="post" action="/slaxis/admin/non_compliance_report/submit">
...
<script type="text/javascript">
  ...
  var getUsersTable = "<?php echo base_url("admin/non_compliance_report/populateTable"); ?>"
  var confirmSelection = "<?php echo base_url("admin/non_compliance_report/confirmSelection"); ?>"
