...
class view_ranges extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/view_ranges', $records);
	}

	public function show_range()
	{
		$encoded_id = $this->input->post('encoded_id');
		$records = $this->global_model->getRow('users', 'encoded_id', $encoded_id);
		...
		$this->load->view('admin/show_range', $data);
		
	}

	public function ajax()
	{
		$records = json_encode($this->global_model->getRecords('users'));
